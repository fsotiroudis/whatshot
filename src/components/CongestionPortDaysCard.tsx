...
const CongestionPortDaysCard: React.FC<CongestionPortDaysCardProps> = ({ dayDate, portName, vesselType }) => {
  ...
  // Find the row with the largest port days change
  ...
  return (
    <div className="bg-white rounded-lg shadow p-4">
      <h3 className="text-gray-500 text-sm mb-1">Congested Port Days</h3>
